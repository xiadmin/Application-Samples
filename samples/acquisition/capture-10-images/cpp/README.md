...
```bash
cd samples/acquisition/capture-10-images/cpp
cmake -B .cmake-tmp
...
```bash
# Linux
.cmake-tmp/build/acquisition-capture-10-images-cpp

# Windows PowerShell
.\.cmake-tmp\build\Release\acquisition-capture-10-images-cpp.exe
```
